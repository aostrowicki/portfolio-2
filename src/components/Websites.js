...
export default function Websites() {
    ...
    return (
        <div className="websites-grid">
            ...
            <Website href="https://aostrowicki.com" githref="https://github.com/aostrowicki/portfolio-2" img={portfolio} title="Portfolio" work={"Portfolio website designed and developed by me. Created with React using React Hooks."} tools={["React", "GSAP", "Adobe Illustrator", "Adobe XD"]} />
